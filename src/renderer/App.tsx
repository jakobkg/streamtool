...
<<<<<<< HEAD
                    ...
                    p1Team: p1TeamSource,
                    setP1Team: configCallbackBuilder(setP1TeamSource, "obs.websocket.sourceName.p1Team"),

                    p2Team: p2TeamSource,
                    setP2Team: configCallbackBuilder(setP2TeamSource, "obs.websocket.sourceName.p2Team"),

                    p1Score: p1ScoreSource,
                    setP1Score: configCallbackBuilder(setP1ScoreSource, "obs.websocket.sourceName.p1Score"),

                    p2Score: p2ScoreSource,
                    setP2Score: configCallbackBuilder(setP2ScoreSource, "obs.websocket.sourceName.p2Score"),
